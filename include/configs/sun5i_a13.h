...
#define CONFIG_IDENT_STRING			" MK802 A10s Dual "
 ...
 * */
#ifdef CONFIG_ENV_IS_IN_NAND_SUNXI
...
#define CONFIG_BOOTCOMMAND	\
  "if fatload nand 0 0x43000000 script.bin && fatload nand 0 0x48000000 uImage; then bootm 0x48000000; fi\0" \
  "if fatload mmc  0 0x43000000 script.bin && fatload mmc  0 0x48000000 uImage; then bootm 0x48000000; fi\0"
